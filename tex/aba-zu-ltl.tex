...
\subsection{Vorteile}
Vorteile evtl besser in die nächste section, da laufzeit (kein exponential blowup) erst interessant, wenn alternierender büchi -> büchi gemacht wurde. sons ist der vergleich mit anderen verfahren witzlos (weil andere verfahren, die direkt ltl->büchi machen einen exponential blowup haben)\todo{besprechen}